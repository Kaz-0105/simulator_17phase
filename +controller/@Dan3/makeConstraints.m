function makeConstraints(obj, mld_matrices, pos_vehs)
    ...
    if ~isfield(pos_vehs, 'north')
        pos_vehs_initial = [pos_vehs.south; pos_vehs.east; pos_vehs.west];
    elseif ~isfield(pos_vehs, 'south')
        pos_vehs_initial = [pos_vehs.north; pos_vehs.east; pos_vehs.west];
    elseif ~isfield(pos_vehs, 'east')
        pos_vehs_initial = [pos_vehs.north; pos_vehs.south; pos_vehs.west];
